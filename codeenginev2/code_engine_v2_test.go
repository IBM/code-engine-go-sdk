...
var _ = Describe(`CodeEngineV2`, func() {
	...
	Describe(`ListAllowedOutboundDestination(listAllowedOutboundDestinationOptions *ListAllowedOutboundDestinationOptions)`, func() {
		...
		Context(`Test pagination helper method on response`, func() {
			It(`Invoke GetNextStart successfully`, func() {
				responseObject := new(codeenginev2.AllowedOutboundDestinationList)
				nextObject := new(codeenginev2.ListNextMetadata)
				nextObject.Start = core.StringPtr("abc-123")
				responseObject.Next = nextObject
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					Expect(req.Method).To(Equal("POST"))
					Expect(req.URL.Query()["version"]).To(Equal([]string{"2024-12-10"}))
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprint(res, `} this is not valid json {`)
				}))
			})
			It(`Invoke CreateAllowedOutboundDestination with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				createAllowedOutboundDestinationOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				createAllowedOutboundDestinationOptionsModel.AllowedOutboundDestination = allowedOutboundDestinationPrototypeModel
				createAllowedOutboundDestinationOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := codeEngineService.CreateAllowedOutboundDestination(createAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateAllowedOutboundDestination(createAllowedOutboundDestinationOptions *CreateAllowedOutboundDestinationOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateAllowedOutboundDestination successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.CreateAllowedOutboundDestinationWithContext(ctx, createAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateAllowedOutboundDestination successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.CreateAllowedOutboundDestination(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateAllowedOutboundDestination with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the CreateAllowedOutboundDestinationOptions model with no property values
				createAllowedOutboundDestinationOptionsModelNew := new(codeenginev2.CreateAllowedOutboundDestinationOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.CreateAllowedOutboundDestination(createAllowedOutboundDestinationOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetAllowedOutboundDestination(getAllowedOutboundDestinationOptions *GetAllowedOutboundDestinationOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetAllowedOutboundDestination with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				getAllowedOutboundDestinationOptionsModel := new(codeenginev2.GetAllowedOutboundDestinationOptions)
				getAllowedOutboundDestinationOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				getAllowedOutboundDestinationOptionsModel.Name = core.StringPtr("my-allowed-outbound-destination")
				getAllowedOutboundDestinationOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := codeEngineService.GetAllowedOutboundDestination(getAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`GetAllowedOutboundDestination(getAllowedOutboundDestinationOptions *GetAllowedOutboundDestinationOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetAllowedOutboundDestination successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.GetAllowedOutboundDestinationWithContext(ctx, getAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetAllowedOutboundDestination successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.GetAllowedOutboundDestination(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetAllowedOutboundDestination with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetAllowedOutboundDestinationOptions model with no property values
				getAllowedOutboundDestinationOptionsModelNew := new(codeenginev2.GetAllowedOutboundDestinationOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.GetAllowedOutboundDestination(getAllowedOutboundDestinationOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteAllowedOutboundDestination(deleteAllowedOutboundDestinationOptions *DeleteAllowedOutboundDestinationOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteAllowedOutboundDestination successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := codeEngineService.DeleteAllowedOutboundDestination(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())

				// Construct an instance of the DeleteAllowedOutboundDestinationOptions model
				deleteAllowedOutboundDestinationOptionsModel := new(codeenginev2.DeleteAllowedOutboundDestinationOptions)
				deleteAllowedOutboundDestinationOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				deleteAllowedOutboundDestinationOptionsModel.Name = core.StringPtr("my-allowed-outbound-destination")
				deleteAllowedOutboundDestinationOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}

				// Invoke operation with valid options model (positive test)
				response, operationErr = codeEngineService.DeleteAllowedOutboundDestination(deleteAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteAllowedOutboundDestination with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(operationErr.Error()).To(ContainSubstring(core.ERRORMSG_SERVICE_URL_MISSING))
				Expect(response).To(BeNil())
				// Construct a second instance of the DeleteAllowedOutboundDestinationOptions model with no property values
				deleteAllowedOutboundDestinationOptionsModelNew := new(codeenginev2.DeleteAllowedOutboundDestinationOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = codeEngineService.DeleteAllowedOutboundDestination(deleteAllowedOutboundDestinationOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					// Verify the contents of the request
					Expect(req.URL.EscapedPath()).To(Equal(updateAllowedOutboundDestinationPath))
			...
			It(`Invoke UpdateAllowedOutboundDestination with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				updateAllowedOutboundDestinationOptionsModel := new(codeenginev2.UpdateAllowedOutboundDestinationOptions)
				updateAllowedOutboundDestinationOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				updateAllowedOutboundDestinationOptionsModel.Name = core.StringPtr("my-allowed-outbound-destination")
				updateAllowedOutboundDestinationOptionsModel.IfMatch = core.StringPtr("testString")
				updateAllowedOutboundDestinationOptionsModel.AllowedOutboundDestination = allowedOutboundDestinationPatchModelAsPatch
				updateAllowedOutboundDestinationOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := codeEngineService.UpdateAllowedOutboundDestination(updateAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`UpdateAllowedOutboundDestination(updateAllowedOutboundDestinationOptions *UpdateAllowedOutboundDestinationOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke UpdateAllowedOutboundDestination successfully with retries`, func() {
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.UpdateAllowedOutboundDestinationWithContext(ctx, updateAllowedOutboundDestinationOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpdateAllowedOutboundDestination successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.UpdateAllowedOutboundDestination(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke UpdateAllowedOutboundDestination with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the UpdateAllowedOutboundDestinationOptions model with no property values
				updateAllowedOutboundDestinationOptionsModelNew := new(codeenginev2.UpdateAllowedOutboundDestinationOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.UpdateAllowedOutboundDestination(updateAllowedOutboundDestinationOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CreateApp(createAppOptions *CreateAppOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateApp with error: Operation response processing error`, func() {
				...
				probePrototypeModel := new(codeenginev2.ProbePrototype)
				probePrototypeModel.FailureThreshold = core.Int64Ptr(int64(5))
				probePrototypeModel.InitialDelay = core.Int64Ptr(int64(5))
				probePrototypeModel.Interval = core.Int64Ptr(int64(5))
				probePrototypeModel.Path = core.StringPtr("testString")
				probePrototypeModel.Port = core.Int64Ptr(int64(8080))
				probePrototypeModel.Timeout = core.Int64Ptr(int64(300))
				probePrototypeModel.Type = core.StringPtr("tcp")
				...
				createAppOptionsModel.ProbeLiveness = probePrototypeModel
				createAppOptionsModel.ProbeReadiness = probePrototypeModel
				...
				createAppOptionsModel.ScaleDownDelay = core.Int64Ptr(int64(300))
	...
	Describe(`UpdateApp(updateAppOptions *UpdateAppOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke UpdateApp with error: Operation response processing error`, func() {
				...
				appPatchModel.ProbeLiveness = probePrototypeModel
				appPatchModel.ProbeReadiness = probePrototypeModel
				...
				appPatchModel.ScaleDownDelay = core.Int64Ptr(int64(300))
	...
	Describe(`CreateJobRun(createJobRunOptions *CreateJobRunOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateJobRun with error: Operation response processing error`, func() {
				...
				createJobRunOptionsModel.ScaleArraySizeVariableOverride = core.Int64Ptr(int64(2))
	...
	Describe(`ListBindings(listBindingsOptions *ListBindingsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListBindings with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				listBindingsOptionsModel := new(codeenginev2.ListBindingsOptions)
				listBindingsOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				listBindingsOptionsModel.Limit = core.Int64Ptr(int64(100))
				listBindingsOptionsModel.Start = core.StringPtr("testString")
				listBindingsOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := codeEngineService.ListBindings(listBindingsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`ListBindings(listBindingsOptions *ListBindingsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"bindings": [{"component": {"name": "my-app-1", "resource_type": "app_v2"}, "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/bindings/my-binding", "id": "a172ced-b5f21bc-71ba50c-1638604", "prefix": "MY_COS", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "resource_type": "binding_v2", "secret_name": "my-service-access", "status": "active"}], "first": {"href": "Href"}, "limit": 100, "next": {"href": "Href", "start": "Start"}}`)
				}))
			})
			It(`Invoke ListBindings successfully with retries`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.ListBindingsWithContext(ctx, listBindingsOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke ListBindings successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.ListBindings(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke ListBindings with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the ListBindingsOptions model with no property values
				listBindingsOptionsModelNew := new(codeenginev2.ListBindingsOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.ListBindings(listBindingsOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
		...
		Context(`Test pagination helper method on response`, func() {
			It(`Invoke GetNextStart successfully`, func() {
				responseObject := new(codeenginev2.BindingList)
				nextObject := new(codeenginev2.ListNextMetadata)
				nextObject.Start = core.StringPtr("abc-123")
				responseObject.Next = nextObject
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"start":"1"},"total_count":2,"bindings":[{"component":{"name":"my-app-1","resource_type":"app_v2"},"href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/bindings/my-binding","id":"a172ced-b5f21bc-71ba50c-1638604","prefix":"MY_COS","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","resource_type":"binding_v2","secret_name":"my-service-access","status":"active"}],"limit":1}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"total_count":2,"bindings":[{"component":{"name":"my-app-1","resource_type":"app_v2"},"href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/bindings/my-binding","id":"a172ced-b5f21bc-71ba50c-1638604","prefix":"MY_COS","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","resource_type":"binding_v2","secret_name":"my-service-access","status":"active"}],"limit":1}`)
					} else {
						res.WriteHeader(400)
					}
				}))
			})
			It(`Use BindingsPager.GetNext successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
			...
			It(`Use BindingsPager.GetAll successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
	...
	Describe(`CreateBinding(createBindingOptions *CreateBindingOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateBinding with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				createBindingOptionsModel := new(codeenginev2.CreateBindingOptions)
				createBindingOptionsModel.ProjectID = core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")
				createBindingOptionsModel.Component = componentRefModel
				createBindingOptionsModel.Prefix = core.StringPtr("MY_COS")
				createBindingOptionsModel.SecretName = core.StringPtr("my-service-access")
				createBindingOptionsModel.Headers = map[string]string{"x-custom-header": "x-custom-value"}
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := codeEngineService.CreateBinding(createBindingOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
	...
	Describe(`CreateBinding(createBindingOptions *CreateBindingOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"component": {"name": "my-app-1", "resource_type": "app_v2"}, "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/bindings/my-binding", "id": "a172ced-b5f21bc-71ba50c-1638604", "prefix": "MY_COS", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "resource_type": "binding_v2", "secret_name": "my-service-access", "status": "active"}`)
				}))
			})
			It(`Invoke CreateBinding successfully with retries`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.CreateBindingWithContext(ctx, createBindingOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CreateBinding successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.CreateBinding(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CreateBinding with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the CreateBindingOptions model with no property values
				createBindingOptionsModelNew := new(codeenginev2.CreateBindingOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.CreateBinding(createBindingOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`GetBinding(getBindingOptions *GetBindingOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke GetBinding with error: Operation response processing error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
	...
	Describe(`GetBinding(getBindingOptions *GetBindingOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetBinding successfully with retries`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				ctx, cancelFunc := context.WithTimeout(context.Background(), 80*time.Millisecond)
				defer cancelFunc()
				_, _, operationErr := codeEngineService.GetBindingWithContext(ctx, getBindingOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(operationErr.Error()).To(ContainSubstring("deadline exceeded"))
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke GetBinding successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := codeEngineService.GetBinding(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke GetBinding with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
				// Construct a second instance of the GetBindingOptions model with no property values
				getBindingOptionsModelNew := new(codeenginev2.GetBindingOptions)
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = codeEngineService.GetBinding(getBindingOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`DeleteBinding(deleteBindingOptions *DeleteBindingOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteBinding successfully`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				// Invoke operation with nil options model (negative test)
				response, operationErr := codeEngineService.DeleteBinding(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				...
				// Invoke operation with valid options model (positive test)
				response, operationErr = codeEngineService.DeleteBinding(deleteBindingOptionsModel)
				Expect(operationErr).To(BeNil())
				Expect(response).ToNot(BeNil())
			})
			It(`Invoke DeleteBinding with error: Operation validation and request error`, func() {
				codeEngineService, serviceErr := codeenginev2.NewCodeEngineV2(&codeenginev2.CodeEngineV2Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
					Version: core.StringPtr(version),
				...
				Expect(operationErr.Error()).To(ContainSubstring(core.ERRORMSG_SERVICE_URL_MISSING))
				Expect(response).To(BeNil())
				// Construct a second instance of the DeleteBindingOptions model with no property values
				deleteBindingOptionsModelNew := new(codeenginev2.DeleteBindingOptions)
				// Invoke operation with invalid model (negative test)
				response, operationErr = codeEngineService.DeleteBinding(deleteBindingOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
			})
			AfterEach(func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"config_maps": [{"created_at": "2022-09-13T11:41:35+02:00", "data": {"mapKey": "Inner"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/config_maps/my-config-map", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-config-map", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "config_map_v2"}], "first": {"href": "Href"}, "limit": 100, "next": {"href": "Href", "start": "Start"}}`)
				}))
			})
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"start":"1"},"config_maps":[{"created_at":"2022-09-13T11:41:35+02:00","data":{"mapKey":"Inner"},"entity_tag":"2385407409","href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/config_maps/my-config-map","id":"e33b1cv7-7390-4437-a5c2-130d5ccdddc3","name":"my-config-map","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","region":"us-east","resource_type":"config_map_v2"}],"total_count":2,"limit":1}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"config_maps":[{"created_at":"2022-09-13T11:41:35+02:00","data":{"mapKey":"Inner"},"entity_tag":"2385407409","href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/config_maps/my-config-map","id":"e33b1cv7-7390-4437-a5c2-130d5ccdddc3","name":"my-config-map","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","region":"us-east","resource_type":"config_map_v2"}],"total_count":2,"limit":1}`)
					} else {
						res.WriteHeader(400)
					}
				}))
	...
	Describe(`CreateConfigMap(createConfigMapOptions *CreateConfigMapOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateConfigMap with error: Operation response processing error`, func() {
				...
				createConfigMapOptionsModel.Data = map[string]string{"key1": "testString"}
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(201)
					fmt.Fprintf(res, "%s", `{"created_at": "2022-09-13T11:41:35+02:00", "data": {"mapKey": "Inner"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/config_maps/my-config-map", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-config-map", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "config_map_v2"}`)
				}))
			})
	...
	Describe(`ReplaceConfigMap(replaceConfigMapOptions *ReplaceConfigMapOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ReplaceConfigMap with error: Operation response processing error`, func() {
				...
				replaceConfigMapOptionsModel.Data = map[string]string{"key1": "testString"}
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			BeforeEach(func() {
				...
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					requestNumber++
					if requestNumber == 1 {
						fmt.Fprintf(res, "%s", `{"next":{"start":"1"},"total_count":2,"limit":1,"secrets":[{"created_at":"2022-09-13T11:41:35+02:00","data":{"mapKey":"Inner"},"entity_tag":"2385407409","format":"generic","href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/secrets/my-secret","id":"e33b1cv7-7390-4437-a5c2-130d5ccdddc3","name":"my-secret","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","region":"us-east","resource_type":"ResourceType","service_access":{"resource_key":{"id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","name":"Name"},"role":{"crn":"crn:v1:bluemix:public:iam::::serviceRole:Writer","name":"Manager"},"service_instance":{"id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","type":"Type"},"serviceid":{"crn":"Crn","id":"ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637"}},"service_operator":{"apikey_id":"ApiKey-17041d26-55e4-40a8-8ab5-5a69b68e204b","resource_group_ids":["ResourceGroupIds"],"serviceid":{"crn":"Crn","id":"ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637"},"user_managed":false}}]}`)
					} else if requestNumber == 2 {
						fmt.Fprintf(res, "%s", `{"total_count":2,"limit":1,"secrets":[{"created_at":"2022-09-13T11:41:35+02:00","data":{"mapKey":"Inner"},"entity_tag":"2385407409","format":"generic","href":"https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/secrets/my-secret","id":"e33b1cv7-7390-4437-a5c2-130d5ccdddc3","name":"my-secret","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","region":"us-east","resource_type":"ResourceType","service_access":{"resource_key":{"id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","name":"Name"},"role":{"crn":"crn:v1:bluemix:public:iam::::serviceRole:Writer","name":"Manager"},"service_instance":{"id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","type":"Type"},"serviceid":{"crn":"Crn","id":"ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637"}},"service_operator":{"apikey_id":"ApiKey-17041d26-55e4-40a8-8ab5-5a69b68e204b","resource_group_ids":["ResourceGroupIds"],"serviceid":{"crn":"Crn","id":"ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637"},"user_managed":false}}]}`)
					} else {
						res.WriteHeader(400)
					}
				}))
	...
	Describe(`CreateSecret(createSecretOptions *CreateSecretOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateSecret with error: Operation response processing error`, func() {
				...
				secretDataModel := new(codeenginev2.SecretDataGenericSecretData)
				secretDataModel.SetProperty("foo", core.StringPtr("testString"))

				// Construct an instance of the ResourceKeyRefPrototype model
				resourceKeyRefPrototypeModel := new(codeenginev2.ResourceKeyRefPrototype)
				resourceKeyRefPrototypeModel.ID = core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")

				// Construct an instance of the RoleRefPrototype model
				roleRefPrototypeModel := new(codeenginev2.RoleRefPrototype)
				roleRefPrototypeModel.Crn = core.StringPtr("crn:v1:bluemix:public:iam::::serviceRole:Writer")

				// Construct an instance of the ServiceInstanceRefPrototype model
				serviceInstanceRefPrototypeModel := new(codeenginev2.ServiceInstanceRefPrototype)
				serviceInstanceRefPrototypeModel.ID = core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")

				// Construct an instance of the ServiceIDRef model
				serviceIdRefModel := new(codeenginev2.ServiceIDRef)
				serviceIdRefModel.Crn = core.StringPtr("testString")
				serviceIdRefModel.ID = core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")

				// Construct an instance of the ServiceAccessSecretPrototypeProps model
				serviceAccessSecretPrototypePropsModel := new(codeenginev2.ServiceAccessSecretPrototypeProps)
				serviceAccessSecretPrototypePropsModel.ResourceKey = resourceKeyRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.Role = roleRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.ServiceInstance = serviceInstanceRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.Serviceid = serviceIdRefModel

				// Construct an instance of the ServiceIDRefPrototype model
				serviceIdRefPrototypeModel := new(codeenginev2.ServiceIDRefPrototype)
				serviceIdRefPrototypeModel.ID = core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")

				// Construct an instance of the OperatorSecretPrototypeProps model
				operatorSecretPrototypePropsModel := new(codeenginev2.OperatorSecretPrototypeProps)
				operatorSecretPrototypePropsModel.ResourceGroupIds = []string{"testString"}
				operatorSecretPrototypePropsModel.Serviceid = serviceIdRefPrototypeModel
				...
				createSecretOptionsModel.ServiceAccess = serviceAccessSecretPrototypePropsModel
				createSecretOptionsModel.ServiceOperator = operatorSecretPrototypePropsModel
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewComponentRef successfully`, func() {
				name := "my-app-1"
				resourceType := "app_v2"
				_model, err := codeEngineService.NewComponentRef(name, resourceType)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewCreateAllowedOutboundDestinationOptions successfully`, func() {
				// Construct an instance of the AllowedOutboundDestinationPrototypeCidrBlockDataPrototype model
				allowedOutboundDestinationPrototypeModel := new(codeenginev2.AllowedOutboundDestinationPrototypeCidrBlockDataPrototype)
				...
				var allowedOutboundDestination codeenginev2.AllowedOutboundDestinationPrototypeIntf = nil
				createAllowedOutboundDestinationOptionsModel := codeEngineService.NewCreateAllowedOutboundDestinationOptions(projectID, allowedOutboundDestination)
				createAllowedOutboundDestinationOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				createAllowedOutboundDestinationOptionsModel.SetAllowedOutboundDestination(allowedOutboundDestinationPrototypeModel)
				createAllowedOutboundDestinationOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(createAllowedOutboundDestinationOptionsModel).ToNot(BeNil())
				Expect(createAllowedOutboundDestinationOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(createAllowedOutboundDestinationOptionsModel.AllowedOutboundDestination).To(Equal(allowedOutboundDestinationPrototypeModel))
				Expect(createAllowedOutboundDestinationOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewCreateAppOptions successfully`, func() {
				// Construct an instance of the ProbePrototype model
				probePrototypeModel := new(codeenginev2.ProbePrototype)
				Expect(probePrototypeModel).ToNot(BeNil())
				probePrototypeModel.FailureThreshold = core.Int64Ptr(int64(5))
				probePrototypeModel.InitialDelay = core.Int64Ptr(int64(5))
				probePrototypeModel.Interval = core.Int64Ptr(int64(5))
				probePrototypeModel.Path = core.StringPtr("testString")
				...
				probePrototypeModel.Timeout = core.Int64Ptr(int64(300))
				probePrototypeModel.Type = core.StringPtr("tcp")
				Expect(probePrototypeModel.FailureThreshold).To(Equal(core.Int64Ptr(int64(5))))
				Expect(probePrototypeModel.InitialDelay).To(Equal(core.Int64Ptr(int64(5))))
				Expect(probePrototypeModel.Interval).To(Equal(core.Int64Ptr(int64(5))))
				Expect(probePrototypeModel.Path).To(Equal(core.StringPtr("testString")))
				Expect(probePrototypeModel.Port).To(Equal(core.Int64Ptr(int64(8080))))
				Expect(probePrototypeModel.Timeout).To(Equal(core.Int64Ptr(int64(300))))
				Expect(probePrototypeModel.Type).To(Equal(core.StringPtr("tcp")))
				...
				createAppOptionsModel.SetProbeLiveness(probePrototypeModel)
				createAppOptionsModel.SetProbeReadiness(probePrototypeModel)
				...
				createAppOptionsModel.SetScaleDownDelay(int64(300))
				...
				Expect(createAppOptionsModel.ProbeLiveness).To(Equal(probePrototypeModel))
				Expect(createAppOptionsModel.ProbeReadiness).To(Equal(probePrototypeModel))
				...
				Expect(createAppOptionsModel.ScaleDownDelay).To(Equal(core.Int64Ptr(int64(300))))
			...
			It(`Invoke NewCreateBindingOptions successfully`, func() {
				// Construct an instance of the ComponentRef model
				componentRefModel := new(codeenginev2.ComponentRef)
				Expect(componentRefModel).ToNot(BeNil())
				componentRefModel.Name = core.StringPtr("my-app-1")
				componentRefModel.ResourceType = core.StringPtr("app_v2")
				Expect(componentRefModel.Name).To(Equal(core.StringPtr("my-app-1")))
				Expect(componentRefModel.ResourceType).To(Equal(core.StringPtr("app_v2")))

				// Construct an instance of the CreateBindingOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				var createBindingOptionsComponent *codeenginev2.ComponentRef = nil
				createBindingOptionsPrefix := "MY_COS"
				createBindingOptionsSecretName := "my-service-access"
				createBindingOptionsModel := codeEngineService.NewCreateBindingOptions(projectID, createBindingOptionsComponent, createBindingOptionsPrefix, createBindingOptionsSecretName)
				createBindingOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				createBindingOptionsModel.SetComponent(componentRefModel)
				createBindingOptionsModel.SetPrefix("MY_COS")
				createBindingOptionsModel.SetSecretName("my-service-access")
				createBindingOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(createBindingOptionsModel).ToNot(BeNil())
				Expect(createBindingOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(createBindingOptionsModel.Component).To(Equal(componentRefModel))
				Expect(createBindingOptionsModel.Prefix).To(Equal(core.StringPtr("MY_COS")))
				Expect(createBindingOptionsModel.SecretName).To(Equal(core.StringPtr("my-service-access")))
			...
			It(`Invoke NewCreateBuildOptions successfully`, func() {
				...
				createBuildOptionsModel := codeEngineService.NewCreateBuildOptions(projectID, createBuildOptionsName, createBuildOptionsOutputImage, createBuildOptionsOutputSecret, createBuildOptionsStrategyType)
			...
			It(`Invoke NewCreateConfigMapOptions successfully`, func() {
				...
				createConfigMapOptionsModel.SetData(map[string]string{"key1": "testString"})
				...
				Expect(createConfigMapOptionsModel.Data).To(Equal(map[string]string{"key1": "testString"}))
				Expect(createConfigMapOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewCreateDomainMappingOptions successfully`, func() {
				// Construct an instance of the ComponentRef model
				componentRefModel := new(codeenginev2.ComponentRef)
				Expect(componentRefModel).ToNot(BeNil())
				componentRefModel.Name = core.StringPtr("my-app-1")
				...
				// Construct an instance of the CreateDomainMappingOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				var createDomainMappingOptionsComponent *codeenginev2.ComponentRef = nil
				createDomainMappingOptionsName := "www.example.com"
				createDomainMappingOptionsTlsSecret := "my-tls-secret"
				createDomainMappingOptionsModel := codeEngineService.NewCreateDomainMappingOptions(projectID, createDomainMappingOptionsComponent, createDomainMappingOptionsName, createDomainMappingOptionsTlsSecret)
				createDomainMappingOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				createDomainMappingOptionsModel.SetComponent(componentRefModel)
				createDomainMappingOptionsModel.SetName("www.example.com")
				createDomainMappingOptionsModel.SetTlsSecret("my-tls-secret")
				createDomainMappingOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(createDomainMappingOptionsModel).ToNot(BeNil())
				Expect(createDomainMappingOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(createDomainMappingOptionsModel.Component).To(Equal(componentRefModel))
			...
			It(`Invoke NewCreateJobRunOptions successfully`, func() {
				...
				createJobRunOptionsModel.SetScaleArraySizeVariableOverride(int64(2))
				...
				Expect(createJobRunOptionsModel.ScaleArraySizeVariableOverride).To(Equal(core.Int64Ptr(int64(2))))
			...
			It(`Invoke NewCreateSecretOptions successfully`, func() {
				...
				// Construct an instance of the ResourceKeyRefPrototype model
				resourceKeyRefPrototypeModel := new(codeenginev2.ResourceKeyRefPrototype)
				Expect(resourceKeyRefPrototypeModel).ToNot(BeNil())
				resourceKeyRefPrototypeModel.ID = core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")
				Expect(resourceKeyRefPrototypeModel.ID).To(Equal(core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")))

				// Construct an instance of the RoleRefPrototype model
				roleRefPrototypeModel := new(codeenginev2.RoleRefPrototype)
				Expect(roleRefPrototypeModel).ToNot(BeNil())
				roleRefPrototypeModel.Crn = core.StringPtr("crn:v1:bluemix:public:iam::::serviceRole:Writer")
				Expect(roleRefPrototypeModel.Crn).To(Equal(core.StringPtr("crn:v1:bluemix:public:iam::::serviceRole:Writer")))

				// Construct an instance of the ServiceInstanceRefPrototype model
				serviceInstanceRefPrototypeModel := new(codeenginev2.ServiceInstanceRefPrototype)
				Expect(serviceInstanceRefPrototypeModel).ToNot(BeNil())
				serviceInstanceRefPrototypeModel.ID = core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")
				Expect(serviceInstanceRefPrototypeModel.ID).To(Equal(core.StringPtr("4e49b3e0-27a8-48d2-a784-c7ee48bb863b")))

				// Construct an instance of the ServiceIDRef model
				serviceIdRefModel := new(codeenginev2.ServiceIDRef)
				Expect(serviceIdRefModel).ToNot(BeNil())
				serviceIdRefModel.Crn = core.StringPtr("testString")
				serviceIdRefModel.ID = core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")
				Expect(serviceIdRefModel.Crn).To(Equal(core.StringPtr("testString")))
				Expect(serviceIdRefModel.ID).To(Equal(core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")))

				// Construct an instance of the ServiceAccessSecretPrototypeProps model
				serviceAccessSecretPrototypePropsModel := new(codeenginev2.ServiceAccessSecretPrototypeProps)
				Expect(serviceAccessSecretPrototypePropsModel).ToNot(BeNil())
				serviceAccessSecretPrototypePropsModel.ResourceKey = resourceKeyRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.Role = roleRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.ServiceInstance = serviceInstanceRefPrototypeModel
				serviceAccessSecretPrototypePropsModel.Serviceid = serviceIdRefModel
				Expect(serviceAccessSecretPrototypePropsModel.ResourceKey).To(Equal(resourceKeyRefPrototypeModel))
				Expect(serviceAccessSecretPrototypePropsModel.Role).To(Equal(roleRefPrototypeModel))
				Expect(serviceAccessSecretPrototypePropsModel.ServiceInstance).To(Equal(serviceInstanceRefPrototypeModel))
				Expect(serviceAccessSecretPrototypePropsModel.Serviceid).To(Equal(serviceIdRefModel))

				// Construct an instance of the ServiceIDRefPrototype model
				serviceIdRefPrototypeModel := new(codeenginev2.ServiceIDRefPrototype)
				Expect(serviceIdRefPrototypeModel).ToNot(BeNil())
				serviceIdRefPrototypeModel.ID = core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")
				Expect(serviceIdRefPrototypeModel.ID).To(Equal(core.StringPtr("ServiceId-8fa4bc74-6441-4e5b-af3a-2b1af325a637")))

				// Construct an instance of the OperatorSecretPrototypeProps model
				operatorSecretPrototypePropsModel := new(codeenginev2.OperatorSecretPrototypeProps)
				Expect(operatorSecretPrototypePropsModel).ToNot(BeNil())
				operatorSecretPrototypePropsModel.ResourceGroupIds = []string{"testString"}
				operatorSecretPrototypePropsModel.Serviceid = serviceIdRefPrototypeModel
				Expect(operatorSecretPrototypePropsModel.ResourceGroupIds).To(Equal([]string{"testString"}))
				Expect(operatorSecretPrototypePropsModel.Serviceid).To(Equal(serviceIdRefPrototypeModel))
				...
				createSecretOptionsModel.SetServiceAccess(serviceAccessSecretPrototypePropsModel)
				createSecretOptionsModel.SetServiceOperator(operatorSecretPrototypePropsModel)
				...
				Expect(createSecretOptionsModel.ServiceAccess).To(Equal(serviceAccessSecretPrototypePropsModel))
				Expect(createSecretOptionsModel.ServiceOperator).To(Equal(operatorSecretPrototypePropsModel))
				Expect(createSecretOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			It(`Invoke NewDeleteAllowedOutboundDestinationOptions successfully`, func() {
				// Construct an instance of the DeleteAllowedOutboundDestinationOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				name := "my-allowed-outbound-destination"
				deleteAllowedOutboundDestinationOptionsModel := codeEngineService.NewDeleteAllowedOutboundDestinationOptions(projectID, name)
				deleteAllowedOutboundDestinationOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				deleteAllowedOutboundDestinationOptionsModel.SetName("my-allowed-outbound-destination")
				deleteAllowedOutboundDestinationOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(deleteAllowedOutboundDestinationOptionsModel).ToNot(BeNil())
				Expect(deleteAllowedOutboundDestinationOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(deleteAllowedOutboundDestinationOptionsModel.Name).To(Equal(core.StringPtr("my-allowed-outbound-destination")))
				Expect(deleteAllowedOutboundDestinationOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewDeleteDomainMappingOptions successfully`, func() {
				// Construct an instance of the DeleteDomainMappingOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				name := "www.example.com"
				deleteDomainMappingOptionsModel := codeEngineService.NewDeleteDomainMappingOptions(projectID, name)
				deleteDomainMappingOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				deleteDomainMappingOptionsModel.SetName("www.example.com")
				deleteDomainMappingOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(deleteDomainMappingOptionsModel).ToNot(BeNil())
				Expect(deleteDomainMappingOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
			...
			It(`Invoke NewGetAllowedOutboundDestinationOptions successfully`, func() {
				// Construct an instance of the GetAllowedOutboundDestinationOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				name := "my-allowed-outbound-destination"
				getAllowedOutboundDestinationOptionsModel := codeEngineService.NewGetAllowedOutboundDestinationOptions(projectID, name)
				getAllowedOutboundDestinationOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				getAllowedOutboundDestinationOptionsModel.SetName("my-allowed-outbound-destination")
				getAllowedOutboundDestinationOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getAllowedOutboundDestinationOptionsModel).ToNot(BeNil())
				Expect(getAllowedOutboundDestinationOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(getAllowedOutboundDestinationOptionsModel.Name).To(Equal(core.StringPtr("my-allowed-outbound-destination")))
				Expect(getAllowedOutboundDestinationOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewGetDomainMappingOptions successfully`, func() {
				// Construct an instance of the GetDomainMappingOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				name := "www.example.com"
				getDomainMappingOptionsModel := codeEngineService.NewGetDomainMappingOptions(projectID, name)
				getDomainMappingOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				getDomainMappingOptionsModel.SetName("www.example.com")
				getDomainMappingOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(getDomainMappingOptionsModel).ToNot(BeNil())
				Expect(getDomainMappingOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
			...
			It(`Invoke NewListBindingsOptions successfully`, func() {
				// Construct an instance of the ListBindingsOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				listBindingsOptionsModel := codeEngineService.NewListBindingsOptions(projectID)
				listBindingsOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				listBindingsOptionsModel.SetLimit(int64(100))
				listBindingsOptionsModel.SetStart("testString")
				listBindingsOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(listBindingsOptionsModel).ToNot(BeNil())
				Expect(listBindingsOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(listBindingsOptionsModel.Limit).To(Equal(core.Int64Ptr(int64(100))))
				Expect(listBindingsOptionsModel.Start).To(Equal(core.StringPtr("testString")))
				Expect(listBindingsOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewListDomainMappingsOptions successfully`, func() {
				// Construct an instance of the ListDomainMappingsOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				listDomainMappingsOptionsModel := codeEngineService.NewListDomainMappingsOptions(projectID)
				listDomainMappingsOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				listDomainMappingsOptionsModel.SetLimit(int64(100))
				listDomainMappingsOptionsModel.SetStart("testString")
				listDomainMappingsOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(listDomainMappingsOptionsModel).ToNot(BeNil())
				Expect(listDomainMappingsOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
			...
			It(`Invoke NewReplaceConfigMapOptions successfully`, func() {
				...
				replaceConfigMapOptionsModel.SetData(map[string]string{"key1": "testString"})
				...
				Expect(replaceConfigMapOptionsModel.Data).To(Equal(map[string]string{"key1": "testString"}))
			...
			It(`Invoke NewReplaceSecretOptions successfully`, func() {
				...
				name := "my-secret"
				ifMatch := "testString"
				replaceSecretOptionsFormat := "generic"
				replaceSecretOptionsModel := codeEngineService.NewReplaceSecretOptions(projectID, name, ifMatch, replaceSecretOptionsFormat)
			...
			It(`Invoke NewUpdateAllowedOutboundDestinationOptions successfully`, func() {
				...
				name := "my-allowed-outbound-destination"
				ifMatch := "testString"
				allowedOutboundDestination := map[string]interface{}{"anyKey": "anyValue"}
				updateAllowedOutboundDestinationOptionsModel := codeEngineService.NewUpdateAllowedOutboundDestinationOptions(projectID, name, ifMatch, allowedOutboundDestination)
				updateAllowedOutboundDestinationOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				updateAllowedOutboundDestinationOptionsModel.SetName("my-allowed-outbound-destination")
				updateAllowedOutboundDestinationOptionsModel.SetIfMatch("testString")
				updateAllowedOutboundDestinationOptionsModel.SetAllowedOutboundDestination(map[string]interface{}{"anyKey": "anyValue"})
				updateAllowedOutboundDestinationOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(updateAllowedOutboundDestinationOptionsModel).ToNot(BeNil())
				Expect(updateAllowedOutboundDestinationOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(updateAllowedOutboundDestinationOptionsModel.Name).To(Equal(core.StringPtr("my-allowed-outbound-destination")))
				Expect(updateAllowedOutboundDestinationOptionsModel.IfMatch).To(Equal(core.StringPtr("testString")))
				Expect(updateAllowedOutboundDestinationOptionsModel.AllowedOutboundDestination).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
				Expect(updateAllowedOutboundDestinationOptionsModel.Headers).To(Equal(map[string]string{"foo": "bar"}))
			})
			...
			It(`Invoke NewUpdateDomainMappingOptions successfully`, func() {
				// Construct an instance of the UpdateDomainMappingOptions model
				projectID := "15314cc3-85b4-4338-903f-c28cdee6d005"
				name := "www.example.com"
				ifMatch := "testString"
				domainMapping := map[string]interface{}{"anyKey": "anyValue"}
				updateDomainMappingOptionsModel := codeEngineService.NewUpdateDomainMappingOptions(projectID, name, ifMatch, domainMapping)
				updateDomainMappingOptionsModel.SetProjectID("15314cc3-85b4-4338-903f-c28cdee6d005")
				updateDomainMappingOptionsModel.SetName("www.example.com")
				updateDomainMappingOptionsModel.SetIfMatch("testString")
				updateDomainMappingOptionsModel.SetDomainMapping(map[string]interface{}{"anyKey": "anyValue"})
				updateDomainMappingOptionsModel.SetHeaders(map[string]string{"foo": "bar"})
				Expect(updateDomainMappingOptionsModel).ToNot(BeNil())
				Expect(updateDomainMappingOptionsModel.ProjectID).To(Equal(core.StringPtr("15314cc3-85b4-4338-903f-c28cdee6d005")))
				Expect(updateDomainMappingOptionsModel.Name).To(Equal(core.StringPtr("www.example.com")))
				Expect(updateDomainMappingOptionsModel.IfMatch).To(Equal(core.StringPtr("testString")))
			...
			It(`Invoke NewSecretDataRegistrySecretData successfully`, func() {
				...
				password := "testString"
				server := "testString"
				_model, err := codeEngineService.NewSecretDataRegistrySecretData(username, password, server)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
	...
	Describe(`Model unmarshaling tests`, func() {
		It(`Invoke UnmarshalAllowedOutboundDestinationPatch successfully`, func() {
			...
			var result *codeenginev2.AllowedOutboundDestinationPatch
			err = codeenginev2.UnmarshalAllowedOutboundDestinationPatch(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		It(`Invoke UnmarshalAllowedOutboundDestinationPrototype successfully`, func() {
			// Construct an instance of the model.
			...
			var result *codeenginev2.AllowedOutboundDestinationPrototype
			err = codeenginev2.UnmarshalAllowedOutboundDestinationPrototype(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
		...
		It(`Invoke UnmarshalAllowedOutboundDestinationPatchCidrBlockDataPatch successfully`, func() {
			...
			var result *codeenginev2.AllowedOutboundDestinationPatchCidrBlockDataPatch
			err = codeenginev2.UnmarshalAllowedOutboundDestinationPatchCidrBlockDataPatch(raw, &result)
			Expect(err).To(BeNil())
			Expect(result).ToNot(BeNil())
			Expect(result).To(Equal(model))
		})
